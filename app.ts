...
class  Student {       // Class name
    ...
    name: string;    // Fields / data memebers
    age: number
    slot: string | number
    rollNo: number
    
   
    constructor(a: string, b: number , c: string | number , d: number) {     // constructor makes your code dynamic
...
class Game {                                                //Parent Class
    move(distanceInKilometers: number = 0) {
      console.log(`Wolf ran way   ${distanceInKilometers}Km.`);
    }
  }
   
  class Dog extends Game {                                  // Child Class
    bark() {
